...
import 'package:myapp/screens/authentication_screen/login_screen.dart';
import 'package:myapp/screens/main_screen/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      builder: (context, Box<int> boxs, child) {
        ...
        return value == 0 ? const LoginScreen() : HomeScreen();
      },
    ));
  }
}
